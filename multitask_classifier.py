...
class MultitaskBERT(nn.Module):
    ...
    def predict_paraphrase(self, input_ids_1, attention_mask_1, input_ids_2, attention_mask_2):
        ...
        concat_output = torch.cat((pooled_output_1, pooled_output_2), dim=-1)
        logits = self.paraphrase_classifier(concat_output)
        return logits
    ...
    def predict_similarity(self, input_ids_1, attention_mask_1, input_ids_2, attention_mask_2):
        ...
        pooled_output_2 = self.forward(input_ids_2, attention_mask_2)
        concat_output = torch.cat((pooled_output_1, pooled_output_2), dim=-1)
        logits = self.similarity_classifier(concat_output)
        return logits
